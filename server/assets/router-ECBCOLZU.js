...
const appCss = "/Diagnostico-de-Maquinas/assets/styles-Bj2SnibS.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sistema Inteligente de Diagnóstico de Máquinas Industriais" },
      { name: "description", content: "Análise por IA de máquinas industriais: consumo, CO₂ e retrofit." },
      { name: "author", content: "Industrial AI" },
...
const $$splitComponentImporter = () => import("./index-CHCpSaaW.js");
